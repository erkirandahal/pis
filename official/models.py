...
class Staff(models.Model):
    ...
    permanentaddr_localleveltype = models.ForeignKey(Province, on_delete=models.CASCADE, related_name='permanentaddr_localleveltype', verbose_name="स्थानीय तह प्रकार")
    ...
    temporaryaddr_localleveltype = models.ForeignKey(Province, on_delete=models.CASCADE, related_name='temporaryaddr_localleveltype', verbose_name="स्थानीय तह प्रकार")
